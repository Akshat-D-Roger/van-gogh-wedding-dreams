...
const EventsSection = () => {
  return (
    <section className="relative z-10 w-full min-h-screen bg-background/95 border-t border-white/10 overflow-hidden">
      ...
      <div className="relative z-30 flex flex-col">
        {events.map((event, index) => (
          <div key={event.name} className="w-full snap-center">
            <EventCard
              title={event.name}
              date={event.date}
              time={event.time}
